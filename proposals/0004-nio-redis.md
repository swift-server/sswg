...
* Review Manager: TBD
* Status: **Implemented**
* Implementation: [mordil/nio-redis](https://github.com/mordil/nio-redis)
...
| **Dependencies** | [SwiftNIO](https://github.com/apple/swift-nio) 2.x, [Server Logging API](https://github.com/apple/swift-server-logging-api) 1.x|

## Introduction

`NIORedis` is a module providing general implementations for connecting to a Redis instance and executing commands against it using Redis' proprietary [**Re**dis **S**eralization **P**rotocol (RESP)](https://redis.io/topics/protocol).
...
[`RESPValue`](https://github.com/Mordil/nio-redis/blob/master/Sources/NIORedis/RESP/RESPValue.swift) represents the different types outlined in Redis' protocol as an **enum**.
...
Native and User Defined Swift types need to be translatable to `RESPValue` for communicating in the **RESP** format - which is provided by the [`RESPValueConvertible`](https://github.com/Mordil/nio-redis/blob/master/Sources/NIORedis/RESP/RESPValueConvertible.swift) protocol.
...
Until now, packages through the SSWG process have been accepted as **Sandbox** maturity - so it's appropriate to justify why `NIORedis` should be the first considered mature enough for _Incubating_.

This package supports:
- ~90 (and counting!) of Redis' commands as convenient extension methods
...
- [Apache 2 license](https://github.com/Mordil/nio-redis/blob/master/LICENSE.txt)
- [Swift Code of Conduct](https://github.com/Mordil/nio-redis/blob/master/CODE_OF_CONDUCT.md)
- [Contributing Guide](https://github.com/Mordil/nio-redis#contributing)
- [CircleCI builds](https://circleci.com/gh/Mordil/nio-redis/tree/master)

As well as Vapor, and I, are in the processes of providing a (framework agnostic) higher-level library: [`RedisKit`](https://github.com/vapor/redis-kit) that Vapor has said they will be using as their implementation in version 4.
